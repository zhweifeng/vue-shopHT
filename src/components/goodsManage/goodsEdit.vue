...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ...
                ruleForm:{
                    ...
                    goodsUrl:"http://p1az9gcpw.bkt.clouddn.com/FnKS-16BP_bAgS7sWyA_XIC-VtyV"
        ...
        mounted(){
            ...
            console.log(this.id);
            console.log('---params,ruleForm-商品信息---',params);
            this.$http.post(getGoodsDetailsNew,params).then(res=>{
                ...
                if(status){
                    ...
                    if(_this.ruleForm.discountStatus==0){
                        _this.discountStatusFlag=true;
                    }else{
                        _this.discountStatusFlag=false;
                    }
                    if(_this.ruleForm.soldout==0){
                        _this.soldoutFlag=true;
                    }else{
                        _this.soldoutFlag=false;
                    }
                    if(_this.ruleForm.commendStatus==1){
                        _this.commendStatusFlag=true;
                    }else{
                        _this.commendStatusFlag=false;
                    }
                    _this.goodsListDesc=_this.ruleForm.goodsDesc.split(',');
                    _this.goodsListPic=_this.ruleForm.goodsDesc.split(',')[0];
                    _this.goodsListUrl=_this.ruleForm.goodsUrl.split(',');
                    
                    //this.ruleForm.goodsUrl=goodsDesc.join(',')[0];
                    //this.ruleForm.goodsList=goodsDesc.join(',');
                    console.log('---res,ruleForm-商品信息---',res);
                }else{
        ...
        methods:{
            ...
            submitSure(){
                ...
                console.log('^^编辑详情信息 params',params)
                //alert();updateGoods
